...
plot(dataSub$Datetime, dataSub$Global_active_power, 
     xaxt = NULL, ylab = "Global Active Power (Kilowatts)", type = "l", xlab = "datetime")
# Voltage
plot(dataSub$Datetime, dataSub$Voltage,
     type = "l", xlab = "datetime", ylab = "Voltage")
# Energy Sub metering
plot(dataSub$Datetime, dataSub$Sub_metering_1, type = "l", ylab = "Energy sub metering", xlab = "datetime")
...
plot(dataSub$Datetime, dataSub$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global Reactive Power")
